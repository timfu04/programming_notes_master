...
//    private final ContentCollectionRepository repository;
    ...
    // Replace "ContentCollectionRepository" with "ContentJdbcTemplateRepository" and adjust other code in this file to make it work with "JdbcTemplate"
    // This file should have errors, require code adjustments
    ...
    public void create(@Valid @RequestBody Content content){
        ...
        // "@Valid" ensure content is valid before running code block below (based on constraints like @NotBlank)
