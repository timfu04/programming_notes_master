...
public class JwtService {
    ...
    private static final String SECRET_KEY = "576E5A7234753778214125442A472D4B614E645267556B58703273357638792F"; // generated from website (256-bit)
    ...
    private boolean isTokenExpired(String token) {
        return extractExpiration(token).before(new Date()); // check whether token expiration is before current date and time
    }

    private Date extractExpiration(String token) {
        return extractClaim(token, Claims::getExpiration); // call getExpiration method for given Claims object
    }
